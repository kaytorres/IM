...
$.fn.sliderNav = function(options) {
	var defaults = { items: ["esp","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"], debug: false, height: null, arrows: true};
	...
	for(var i in o.items) 
	{
		if(o.items[i]=='esp')
		{
			$('.slider-nav ul', slider).append("<li><a alt='#"+o.items[i]+"'>#</a></li>");
		}
		else
		{
